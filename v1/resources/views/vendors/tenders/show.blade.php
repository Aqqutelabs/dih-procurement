...
@section('content')
    <div class="vertiqal-dashboard-content">
                    ...
                    <div class="vertiqal-info-item">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="vertiqal-info-value">{{ $tender->buyer->name }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="vertiqal-info-item">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="vertiqal-info-value">{{ $tender->quantity }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="vertiqal-info-item">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="vertiqal-info-value">{{ $tender->delivery_location }}</div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="vertiqal-card">
            ...
            @if (!empty($tender->document) && is_array($tender->document))
                @foreach ($tender->document as $file)
                    @php
                    ...
                    <div class="vertiqal-attachment">
                        <div class="vertiqal-attachment-info">
                            ...
                            <div>
                                <div class="vertiqal-attachment-name">{{ $fileName }}</div>
                                <div class="vertiqal-attachment-size">{{ $fileSize }}</div>
                            </div>
                        </div>
        ...
        <div class="vertiqal-submit-section">
            ...
            <a href="{{ route('bids.create', ['tender_id' => $tender->id]) }}"><button class="vertiqal-submit-btn">Submit
                    Bid</button></a>
        </div>
    </div>
@endsection
