...
<head>
    ...
    <title>Vertiqal - Vendor Login</title>
            ...
            <div class="vertiqal-form-container" id="signin-section">
                ...
                <form action="{{ route('login') }}" method="post">
                    ...
                    <div class="vertiqal-form-group">
                        ...
                        <input type="text" name="email" class="vertiqal-form-input" value="{{ old('email') }}" placeholder="Enter Email Address" required>
                        
                        @error('email')
                        <label class="text-danger text-small" style="color: #b51010 !important">{{ $message }}</label>
                        @enderror
                    </div>

                    <div class="vertiqal-form-group mt-4">
                        <label class="vertiqal-form-label" for="password">Password</label>
                        <input type="password" name="password" value="{{ old('password') }}" id="password" class="vertiqal-form-input" placeholder="Enter Password" required>
                        @error('password')
                        <label class="text-danger" style="color: #b51010 !important">{{ $message }}</label>
                        @enderror
                    </div>
