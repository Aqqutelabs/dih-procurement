...
<div class="vertiqal-main-content">
    <div class="vertiqal-dashboard-content">
        ...
        <div class="vertiqal-header">
            <div class="w-100">
                <a href="tenders.php" class="vertiqal-back-btn">
        ...
        <div class="vertiqal-card">
            ...
            <textarea class="vertiqal-question-input"
                placeholder="e.g., Can we deliver in 2 batches? What are the Payment terms?"></textarea>
