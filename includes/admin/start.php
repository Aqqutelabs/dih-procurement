    ...
    <div class="vertiqal-sidebar">
        <div class="vertiqal-logo">
            <div class="d-flex align-items-center">
                <div class="vertiqal-logo-icon">
                    <i class="fas fa-diamond" style="color: white; font-size: 16px;"></i>
                </div>
                <h1 class="vertiqal-logo-text">Vertiqal</h1>
            </div>
        </div>
        ...
        <ul class="vertiqal-nav">
            ...
            <li class="vertiqal-nav-item">
                <a href="purchase.php" class="vertiqal-nav-link <?= basename($_SERVER['PHP_SELF']) == "purchase.php" ? 'active' : ''; ?>">
